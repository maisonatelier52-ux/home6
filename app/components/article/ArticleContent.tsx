            ...
            {typeof content === 'string' ? (
                ...
                content.map((block, index) => {
                    switch (block.type) {
                        ...
                        case 'quote':
                            return (
                                <blockquote key={index} className="border-l-4 border-red-500 bg-gray-400 pl-6 pr-4 py-6 my-10 italic text-gray-900 text-xl md:text-2xl tracking-wide rounded-r-sm font-semibold shadow-sm">
